...
from sqlalchemy import Column, Table, INTEGER, TEXT, FLOAT, ForeignKey, ForeignKeyConstraint
...
class CombinedComponents(Base):
    ...
    combined = relationship('Combined', backref='combined_components', primaryjoin=(combined_id == Combined.id), foreign_keys=[sequence_id, combined_id] )
